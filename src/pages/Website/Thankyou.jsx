  ...
  return (
    <div className="min-h-screen flex flex-col justify-between relative bg-black">
      ...
      <div className="py-[3rem] z-10 overflow-hidden border-t border-secondary/50 relative">
        ...
        <div className="wrapper flex flex-col justify-between gap-10">
          <p className="">
            Copyright &copy; {new Date().getFullYear()} All rights reserved.
          </p>
          <div className="flex gap-4 items-center ">
            <Link to={companyDetails.linkedin} className="link">
              <FaFacebookF className="w-6 h-6 link" strokeWidth={1.5} />
            </Link>
            <Link to={companyDetails.instagram} className="link">
              <FaInstagram className="w-6 h-6 link" strokeWidth={1.5} />
            </Link>
            <Link to={companyDetails.linkedin} className="link">
              <FaLinkedin className="w-6 h-6 link" strokeWidth={1.5} />
            </Link>
            <Link to={companyDetails.linkedin} className="link">
              <FaTwitter className="w-6 h-6 link" strokeWidth={1.5} />
            </Link>
